...
class Command(CommandContextMixIn):
    ...
    def _main(self, args):
        ...
        # The pip version check wraps the command body rather than trailing
        # it: everything it needs from the environment is gathered before the
        # command gets a chance to modify that environment, and only the
        # already-computed result is rendered afterwards.
